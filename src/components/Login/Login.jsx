...
const Login = ({ onRegisterClick, onLoginSuccess }) => {  // Lägg till onLoginSuccess som prop
    ...
    const handleLogin = () => {
        ...
        // Kolla om användarnamnet och lösenordet matchar någon användare i JSON-Users 
        ...
        if (user) {
            ...
            onLoginSuccess(); // Anropar onLoginSuccess för att indikera att inloggningen lyckats
        } else {
